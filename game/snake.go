...
func NewSnake() *Snake {
	...
	snake.Entity = tl.NewEntity(5, 1, 1, 1)
	...
	snake.Bodylength = []Coordinates{
		...
		{2, 6}, // Body (The body will grow taller when a new head is created, the last piece of the body will become the tail if there is collision with food)
